package com.dicoding.picodiploma.tresh20.customview
...
import com.dicoding.picodiploma.tresh20.R
import com.google.android.material.textfield.TextInputEditText

class PassEmail : TextInputEditText, View.OnTouchListener {
    ...
    private fun init() {
        eyeIcon = ContextCompat.getDrawable(context, R.drawable.ic_eyeoff) as Drawable // x button
                ...
                return when (event.action) {
                    MotionEvent.ACTION_DOWN -> {
                        ...
                        if (transformationMethod.equals(HideReturnsTransformationMethod.getInstance())) {
                            ...
                            eyeIcon = ContextCompat.getDrawable(context, R.drawable.ic_eyeoff) as Drawable
                            showEyeButton()
                        } else {
                            transformationMethod = HideReturnsTransformationMethod.getInstance()
                            eyeIcon = ContextCompat.getDrawable(context, R.drawable.ic_openeye) as Drawable
                            showEyeButton()
                        }
                        true
                    }
